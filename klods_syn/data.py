...
# %% auto #0
__all__ = ['DATA_DIR', 'PHOTOS_DIR', 'MIN_IMAGES_PER_CLASS', 'RANDOM_SEED', 'RESULTS_DIR', 'BATCH_SIZE', 'NUM_WORKERS',
           'BACKBONES', 'download_and_extract', 'inspect_coco', 'crop_coco_annotations', 'LegoDataset',
           'load_class_map', 'load_image_paths', 'filter_to_overlap', 'load_convnext_v2_tiny', 'load_dinov2_vits14',
           'load_efficientnet_b0', 'load_dinov3_vits16', 'extract_embeddings', 'get_device',
           'extract_and_cache_embeddings']

# %% ../nbs/100_data.ipynb #355c06d4
